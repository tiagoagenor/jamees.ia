...
@section('title', 'Editar Forma de Pagamento - ' . $formaPagamento->nome)
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-2">Edite os dados da forma de pagamento "{{ $formaPagamento->nome }}"</p>
            </div>
            <div class="flex space-x-3">
                ...
                <a href="{{ route('forma-pagamento.show', $formaPagamento) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <form method="POST" action="{{ route('forma-pagamento.update', $formaPagamento) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="modalidade"
                        ...
                        @foreach($modalidades as $modalidade)
                            <option value="{{ $modalidade->value }}" {{ old('modalidade', $formaPagamento->modalidade->value) == $modalidade->value ? 'selected' : '' }}>
                                {{ $modalidade->getLabel() }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="conta_empresa_id"
                        ...
                        @foreach($contasEmpresa as $conta)
                            <option value="{{ $conta->id }}" {{ old('conta_empresa_id', $formaPagamento->conta_empresa_id) == $conta->id ? 'selected' : '' }}>
                                {{ $conta->nome }}
                                @if($conta->banco)
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           id="numero_parcelas"
                           value="{{ old('numero_parcelas', $formaPagamento->numero_parcelas) }}"
                           min="1"
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('intercalo_parcelas', $formaPagamento->intercalo_parcelas) }}"
                           min="1"
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           id="primeira_parcela"
                           value="{{ old('primeira_parcela', $formaPagamento->primeira_parcela) }}"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number"
                           name="taxa_banco"
                           id="taxa_banco"
                           value="{{ old('taxa_banco', $formaPagamento->taxa_banco) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number"
                           name="taxa_operadora"
                           id="taxa_operadora"
                           value="{{ old('taxa_operadora', $formaPagamento->taxa_operadora) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number"
                           name="juros_multa"
                           id="juros_multa"
                           value="{{ old('juros_multa', $formaPagamento->juros_multa) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number"
                           name="juros_mora"
                           id="juros_mora"
                           value="{{ old('juros_mora', $formaPagamento->juros_mora) }}"
                           step="0.01"
                           min="0"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               id="disponivel"
                               value="1"
                               {{ old('disponivel', $formaPagamento->disponivel) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('confirmacao_automatica', $formaPagamento->confirmacao_automatica) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               id="gerar_boleto"
                               value="1"
                               {{ old('gerar_boleto', $formaPagamento->gerar_boleto) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               id="permite_deletar"
                               value="1"
                               {{ old('permite_deletar', $formaPagamento->permite_deletar) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
            ...
            <div class="mt-8 flex justify-end space-x-3">
                <a href="{{ route('forma-pagamento.show', $formaPagamento) }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium">
                    Cancelar
                </a>
