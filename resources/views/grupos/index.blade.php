                        ...
                        @foreach($grupos as $grupo)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('grupos.show', $grupo) }}" class="text-blue-600 hover:text-blue-900">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('grupos.edit', $grupo) }}" class="text-indigo-600 hover:text-indigo-900">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        @if(!$grupo->administrativo)
                                            <button onclick="confirmarExclusao('{{ $grupo->id }}', '{{ $grupo->nome }}')" class="text-red-600 hover:text-red-900">
