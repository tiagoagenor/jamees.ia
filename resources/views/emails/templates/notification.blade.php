...
<head>
    ...
    <title>{{ $title ?? 'Notificação - Sistema JAMEES' }}</title>
    <style>
        /* Reset styles */
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="email-container">
                    ...
                    <tr>
                        <td class="email-content">
                            ...
                            <h1 class="email-title">{{ $title ?? 'Notificação do Sistema' }}</h1>

                            <div class="email-message">
                                <p>{{ $message ?? 'Você recebeu uma notificação do Sistema JAMEES.' }}</p>
                            </div>
                            ...
                            @if(isset($additionalInfo))
                                <div class="notification-box">
                                    <h4 class="notification-title">💡 Informação Adicional</h4>
                                    <p class="notification-text">{{ $additionalInfo }}</p>
                                </div>
                            @endif
                        </td>
                    </tr>
