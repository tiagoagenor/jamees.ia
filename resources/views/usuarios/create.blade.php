...
<div id="usuarios-create-app" class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('usuarios.store') }}" class="p-6 space-y-6">
            ...
            <!-- Horários de Acesso -->
            <div class="space-y-6">
                <h4 class="text-md font-medium text-gray-900 border-b border-gray-200 pb-2">Horários de Acesso</h4>
                ...
                <div>
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('horario_acesso_ativo') ? 'checked' : '' }}
                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                ...
                <div id="horario-acesso-campos" style="display: {{ old('horario_acesso_ativo') ? 'block' : 'none' }};">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Início do Almoço -->
                            <div>
                                <label for="hora_almoco_inicio" class="block text-sm font-medium text-gray-700 mb-1">
                                    Início do Almoço <span class="text-red-500">*</span>
                                </label>
                                <input type="time"
                                       id="hora_almoco_inicio"
                                       name="hora_almoco_inicio"
                                       value="{{ old('hora_almoco_inicio', '12:00') }}"
                            ...
                            <!-- Fim do Almoço -->
                            <div>
                                <label for="hora_almoco_fim" class="block text-sm font-medium text-gray-700 mb-1">
                                    Fim do Almoço <span class="text-red-500">*</span>
                                </label>
                                <input type="time"
                                       id="hora_almoco_fim"
                                       name="hora_almoco_fim"
                                       value="{{ old('hora_almoco_fim', '13:00') }}"
                            ...
                            <!-- Hora de Saída -->
                            <div>
                                <label for="hora_saida" class="block text-sm font-medium text-gray-700 mb-1">
                                    Hora de Saída <span class="text-red-500">*</span>
                                </label>
                                <input type="time"
                                       id="hora_saida"
                                       name="hora_saida"
                                       value="{{ old('hora_saida', '18:00') }}"
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                @php
                                    ...
                                    $diasSelecionados = old('dias_permitidos', $diasPadrao);
                                @endphp
